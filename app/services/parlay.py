"""
Parlay service for calculating parlay odds and metrics.
"""
...
class ParlayService:
    """Service for calculating parlay odds and metrics."""
    ...
    @classmethod
    def compute_parlay_odds(cls, bets: List[Dict]) -> ParlayResult:
        """
        ...
        Returns:
            ParlayResult: Object containing parlay metrics
        """
        ...
        for bet in bets:
            ...
            market_dec_odds = cls.american_to_decimal(float(bet['odds']))
        ...
        true_american_odds = cls.decimal_to_american(true_decimal_odds)
        ...
        kelly = cls.kelly_fraction(true_decimal_odds, true_prob_product)
        
        # Check for correlation
        correlated = cls.check_correlation(bets)
